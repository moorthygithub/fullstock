...
const PaymentLedgerReport = () => {
  ...
  const handlePrintPdf = useReactToPrint({
    ...
    documentTitle: "Payment_Ledger_report",
    pageStyle: `
      @page {
        size: A4 portrait;
        margin: 5mm;
  ...
  const downloadExcel = async () => {
    ...
    worksheet.addRow([`Payment Ledger Report`]);
    worksheet.addRow([
    ...
    link.href = url;
    link.download = `Paymentledger.xlsx`;
    link.click();
  ...
  const renderContent = () => {
        ...
        <Card className="w-full max-w-md mx-auto mt-6">
          <CardHeader>
            <CardTitle className="text-destructive">
              Error Fetching Payment Ledger Data
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-gray-600 mb-4">
              Unable to retrieve Payment Ledger information. Please try again.
            </p>
        ...
        <div ref={containerRef} className="mt-4">
          <div className="bg-white rounded-lg shadow-sm p-0 md:p-4">
            <div className="flex justify-between">
              <h2 className="text-lg font-bold mb-4">Payment Ledger Report</h2>
    ...
    return (
      <div className="flex flex-col items-center justify-center h-64 text-gray-500">
        ...
        <p className="text-md">Search for an item to view payment Ledger details</p>
      </div>
    );
  };
