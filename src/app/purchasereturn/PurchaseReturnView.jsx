import { PURCHASE_EDIT_LIST, PURCHASE_RETURN_EDIT_LIST } from "@/api";
...
const PurchaseReturnView = () => {
  ...
  const {
    ...
    queryKey: ["purchasereturnByid", decryptedId],
    queryFn: async () => {
  ...
  useEffect(() => {
    if (PurchasereturnId) {
      setPurchase(PurchasereturnId.purchase);
      setBuyer(PurchasereturnId.buyer);
      setPurchaseSubData(PurchasereturnId.purchaseSub);
    }
  }, [PurchasereturnId]);
  ...
  return (
    <Page>
      ...
      <div
        ...
        ref={containerRef}
      >
        <h2 className="text-center font-bold text-lg py-2 ">PURCHASE RETURN</h2>
