...
const productRowSchema = z.object({
  dispatch_sub_item_id: z.string().min(1, "item data is required"),
  dispatch_sub_box: z.string().min(1, "Box data is required"),
  dispatch_sub_godown_id: z.string().min(1, "Box data is required"),
});

const contractFormSchema = z.object({
  dispatch_date: z.string().min(1, "P Date is required"),
  dispatch_buyer_id: z.number().min(1, "Buyer Id is required"),
  dispatch_buyer_city: z.string().min(1, "City is required"),
  dispatch_ref_no: z.string().min(1, "Ref is required"),
  dispatch_vehicle_no: z.any().optional(),
  dispatch_remark: z.any().optional(),
  dispatch_product_data: z.array(productRowSchema),
});
...
const CreateSales = () => {
  ...
  const handlePaymentChange = (selectedValue, rowIndex, fieldName) => {
    ...
    if (fieldName === "sales_sub_item") {
      ...
      if (["sales_sub_weight", "dispatch_sub_box"].includes(fieldName)) {
        if (!/^\d*$/.test(value)) {
  ...
  const handleInputChange = (e, field) => {
    ...
    if (field === "sales_buyer_name") {
      ...
      if (selectedBuyer) {
        ...
        updatedFormData.dispatch_buyer_id = selectedBuyer.id;
      } else {
  ...
  const fieldLabels = {
    dispatch_date: "Sales Date",
    sales_buyer_name: "Buyer Name",
    dispatch_buyer_id: "Sales Id",
    dispatch_buyer_city: "Buyer City",
    dispatch_ref_no: "Ref No",
    dispatch_vehicle_no: "Vehicle No",
    sales_sub_category: "Category",
    sales_sub_item: "Item",
    sales_sub_size: "Size",
    sales_sub_brand: "Brand",
    sales_sub_weight: "Weight",
    dispatch_sub_box: "Box",
  };
                  ...
                  <div className="md:col-span-3">
                    <div>
                      ...
                      <Textarea
                        ...
                        value={formData.dispatch_remark}
                        onChange={(e) =>
                          handleInputChange(e, "dispatch_remark")
                        }
